...
namespace EasyDouyin\MicroMerchant\Kernel;

use EasyDouyin\Kernel\Exceptions\InvalidArgumentException;
use EasyDouyin\Kernel\Support;
use EasyDouyin\MicroMerchant\Application;
use EasyDouyin\MicroMerchant\Kernel\Exceptions\EncryptException;
use EasyDouyin\Payment\Kernel\BaseClient as PaymentBaseClient;
...
class BaseClient extends PaymentBaseClient
{
     ...
     *
     * @return array|\EasyDouyin\Kernel\Support\Collection|object|\Psr\Http\Message\ResponseInterface|string
     *
     * @throws \EasyDouyin\Kernel\Exceptions\InvalidArgumentException
     * @throws \EasyDouyin\Kernel\Exceptions\InvalidConfigException
     * @throws \EasyDouyin\MicroMerchant\Kernel\Exceptions\InvalidSignException
     ...
     *
     * @throws \EasyDouyin\Kernel\Exceptions\InvalidArgumentException
     * @throws \EasyDouyin\MicroMerchant\Kernel\Exceptions\EncryptException
     */
