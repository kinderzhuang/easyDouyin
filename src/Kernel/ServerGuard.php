...
use EasyDouyin\Kernel\Contracts\MessageInterface;
use EasyDouyin\Kernel\Exceptions\BadRequestException;
use EasyDouyin\Kernel\Exceptions\InvalidArgumentException;
use EasyDouyin\Kernel\Messages\Message;
use EasyDouyin\Kernel\Messages\News;
use EasyDouyin\Kernel\Messages\NewsItem;
use EasyDouyin\Kernel\Messages\Raw as RawMessage;
use EasyDouyin\Kernel\Messages\Text;
use EasyDouyin\Kernel\Support\XML;
use EasyDouyin\Kernel\Traits\Observable;
use EasyDouyin\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
     ...
     * @return $this
     *
     * @throws \EasyDouyin\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\EasyDouyin\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \EasyDouyin\Kernel\Exceptions\InvalidArgumentException
     * @throws \EasyDouyin\Kernel\Exceptions\InvalidConfigException
    ...
    /**
     * @param \EasyDouyin\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \EasyDouyin\Kernel\Exceptions\InvalidArgumentException
